package com.solace.demo.iot.common.movieParser.jna;
...
interface MediaInfoLibrary extends Library {
    ...
    MediaInfoLibrary INSTANCE = (MediaInfoLibrary) 
            Native.loadLibrary("./src/main/resources/MediaInfoLibrary/mediaInfo-1.0.dll", MediaInfoLibrary.class, singletonMap(OPTION_FUNCTION_MAPPER, new FunctionMapper() {
