...
@Service
public class SubRaw360VideoQueueService {

    private static final String SAMPLE_NAME = SubRaw360VideoQueueService.class.getSimpleName();
    private static final String QUEUE_NAME = "360P_Subscriber";
    ...
    public void startRawSubscriber() {
        ...
        System.out.println(API + " " + SAMPLE_NAME + "360P initializing...");
...
//            }
            ...
            try (FileOutputStream fos = new FileOutputStream(file);
                ...
                ffmpeg_wrapper_service.startFFMPEGTranscoding(bitRate,"360",localFileName,subFileUploadDir);
