...
@Service
public class SubRaw144VideoQueueService {

    private static final String SAMPLE_NAME = SubRaw144VideoQueueService.class.getSimpleName();
    private static final String QUEUE_NAME = "144P_Subscriber";
    ...
    public void startRawSubscriber() {
        ...
        System.out.println(API + " " + SAMPLE_NAME + "144P initializing...");
...
//            }
            ...
            try (FileOutputStream fos = new FileOutputStream(file);
                ...
                ffmpeg_wrapper_service.startFFMPEGTranscoding(bitRate,"144",localFileName,subFileUploadDir);
