...
@Service
public class SubRaw1080VideoQueueService {

    private static final String SAMPLE_NAME = SubRaw1080VideoQueueService.class.getSimpleName();
    private static final String QUEUE_NAME = "1080P_Subscriber";
    ...
    public void startRawSubscriber() {
        ...
        System.out.println(API + " " + SAMPLE_NAME + "1080P initializing...");
...
//            }
            ...
            try (FileOutputStream fos = new FileOutputStream(file);
                ...
                ffmpeg_wrapper_service.startFFMPEGTranscoding(bitRate,"1080",localFileName,subFileUploadDir);
