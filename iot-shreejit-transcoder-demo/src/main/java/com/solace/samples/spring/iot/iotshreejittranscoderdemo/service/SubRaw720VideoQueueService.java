...
@Service
public class SubRaw720VideoQueueService {

    private static final String SAMPLE_NAME = SubRaw720VideoQueueService.class.getSimpleName();
    private static final String QUEUE_NAME = "720P_Subscriber";
    ...
    public void startRawSubscriber() {
        ...
        System.out.println(API + " " + SAMPLE_NAME + "720P initializing...");
...
//            }
            ...
            try (FileOutputStream fos = new FileOutputStream(file);
                ...
                ffmpeg_wrapper_service.startFFMPEGTranscoding(bitRate,"720",localFileName,subFileUploadDir);
